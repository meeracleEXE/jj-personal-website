...
const PageShell$1 = "";
const pic = "/assets/static/jjheadshot.5a800107.jpg";
const linkedin = "/assets/static/linkedin-icon.8d743f0f.png";
const github = "/assets/static/github-icon.d83ddf4e.png";
const locationIcon = "/assets/static/location-icon.3584afc6.png";
const mailIcon = "/assets/static/mail-icon.ff3cc82c.png";
function PageShell({
  pageContext,
  children
}) {
